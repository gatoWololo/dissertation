\chpt{Tivo}
This chapter is an updated and revised version the original lightweight record-and-replay white paper \citep{tivo}. This project eventually came to be known as Tivo.
\section{Abstract}
